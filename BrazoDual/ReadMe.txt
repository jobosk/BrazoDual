...
El Asistente para aplicaciones ha creado esta aplicación BrazoDual.
...
constituyen su aplicación BrazoDual.
...
BrazoDual.cpp
    ...
    de la aplicación CBrazoDualApp.
...
BrazoDualDlg.h, BrazoDualDlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase CBrazoDualDlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en BrazoDual.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado BrazoDual.pch y un archivo de 
