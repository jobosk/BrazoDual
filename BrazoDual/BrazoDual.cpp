...
// BrazoDual.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CBrazoDualApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CBrazoDualApp

CBrazoDualApp::CBrazoDualApp()
{
...
// El único objeto CBrazoDualApp

CBrazoDualApp theApp;


// Inicialización de CBrazoDualApp

BOOL CBrazoDualApp::InitInstance()
{
